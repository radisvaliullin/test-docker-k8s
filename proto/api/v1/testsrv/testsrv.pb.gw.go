...
/*
Package testsrv is a reverse proxy.
...
func local_request_TestService_Req_0(ctx context.Context, marshaler runtime.Marshaler, server TestServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Request
	var metadata runtime.ServerMetadata
...
func RegisterTestServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TestServiceServer) error {
	...
	mux.Handle("POST", pattern_TestService_Req_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_TestService_Req_0(rctx, inboundMarshaler, server, req, pathParams)
...
var (
	pattern_TestService_Req_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "req"}, "", runtime.AssumeColonVerbOpt(true)))
)
